...
static void _slurm_rpc_allocate_resources(slurm_msg_t *msg)
{
	...
	START_TIMER;	//开始计时
	//newadd
	printf("ljxprint:src.slurmctld.proc_req._slurm_rpc_allocate_res.job_desc_msg.ifai:%d\n",job_desc_msg->ifai);
	printf("ljxprint:src.slurmctld.proc_req._slurm_rpc_allocate_res.job_desc_msg.jobid:%d\n",job_desc_msg->job_id);
